                ...
                <table class="table">
                    ...
                    <tbody wire:poll>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="truncate text-xs text-slate-500 dark:text-slate-400">{{$options['cate']}}</p>
                                    </div>
                                </div>
                            </td>
                            <td>{{$prod->code}}</td>
                            ...
                            <td>
                                <div class="badge @if ( $options['stat'] == 'Active' ) badge-soft-success @else badge-danger @endif">{{$options['stat']}}</div>
                            </td>
                ...
                <section class="flex flex-col gap-8 lg:col-span-2 w-full">
                    ...
                    <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                        ...
                        <div class="py-2">
                            ...
                            <input type="text" wire:model='pname' class="input @error('pname') is-invalid @enderror" id="name"
                                placeholder="Write Product Name" />
                        </div>
                        <div class="py-2">
                            <label class="label label-required mb-1 font-medium" for="code">Code</label>
                            <div class="inputc flex">
                                <input type="text" wire:model='pcode' class="input @error('pcode') is-invalid @enderror" id="code"
                                    placeholder="Write Product Code" value="{{$pccode}}"/>
                                <button wire:click='pcde' type="button" class="border-[1px] border-[#475569] rounded-[0.4rem] rounded-r-0 w-12 @error('pcode') is-invalid @enderror"><iconify-icon icon="uim:refresh"></iconify-icon></button>
                            </div>
                        </div>
                        <div class="py-2">
                    ...
                    <div class="sticky top-20 rounded-primary bg-white p-6 shadow dark:bg-slate-800">
                        ...
                        <div class="flex flex-col gap-4">
                            <div>
                                ...
                                <select wire:model='pstat' class="select @error('pstat') is-invalid @enderror" id="status">
                            ...
                            <div>
                                ...
                                <select wire:model='pcate' class="select @error('pcate') is-invalid @enderror" id="category">
                            ...
                            <div>
                                ...
                                <select wire:model='pvend' class="select @error('pvend') is-invalid @enderror" id="vendor">
                            ...
                            <div>
                                ...
                                <input wire:model='ppric' type="number" class="input @error('ppric') is-invalid @enderror" id="code" />
                            </div>
